export async function getDataPlans(
  ...
  /*
   * ClubKonnect uses APIDatabundlePlansV2.asp
   * to retrieve the available data-plan catalogue.
   *
   * MobileNumber is NOT required for the plans catalogue.
   * It is required later when purchasing a selected plan
   * through APIDatabundleV1.asp.
   */
  const url = buildUrl(
