...
const durationTabs: PlanDuration[] = [
  'DAILY',
  'WEEKLY',
  'MONTHLY',
];
...
function getPlanDuration(
  ...
  /*
   * Fallback:
   * If the provider does not expose validity but explicitly calls
   * a plan Daily / Weekly / Monthly, use that.
   */
  if (
    text.includes('DAILY') ||
  ...
  /*
   * Most Nigerian monthly bundles are 30 days.
   * Unknown plans are kept under Monthly instead of being hidden.
   */
  return 'MONTHLY';
}
...
function getPlanDisplayName(
  ...
  /*
   * Removes validity text from names such as:
   * "500.0MB 30-DAYS"
   * "1GB - 7 DAYS"
   */
  return raw
      ...
      <div className="mx-auto w-full max-w-2xl px-3 py-4">
        ...
        <div className="flex items-center justify-between gap-3 mb-5">
          <button
            ...
            className="w-10 h-10 rounded-full border border-border bg-card flex items-center justify-center hover:bg-white/5 transition-colors"
            aria-label="Go back"
          >
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center justify-between gap-2">
                          <div
                            className={`w-9 h-9 rounded-lg ${item.color} ${item.text} flex items-center justify-center font-black text-[10px]`}
                          >
                            {item.name ===
                            '9mobile'
                              ? '9M'
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="w-8 h-8 rounded-lg border border-border bg-card flex items-center justify-center hover:bg-white/5 transition-colors disabled:opacity-50"
              ...
              <>
                ...
                0 ? (
                  <div className="rounded-xl border border-border p-6 text-center text-sm text-muted-foreground">
                    ...
                    plans available for this network.
                  </div>
                ) : (
                  /*
                    ...
                    {visiblePlans.map(
                      item => {
                        ...
                        return (
                          ...
                          >
                            {/* DATA SIZE */}
                            <p className="truncate text-[13px] sm:text-sm font-extrabold leading-tight">
                              {displayName}
                            </p>

                            {/* VALIDITY */}
                            <p className="mt-1 text-[9px] sm:text-[10px] font-semibold uppercase tracking-wide text-primary">
                              {duration}
                            </p>

                            {/* PRICE */}
                            <p className="mt-2 truncate text-[12px] sm:text-sm font-extrabold leading-tight">
                              {formatPrice(
                                item.Price,
                              )}
                            </p>
            ...
            <div className="rounded-xl border border-border bg-card p-4 space-y-3">
              ...
              <div className="border-t border-border pt-3">
                <div className="flex items-center justify-between gap-4">
                  ...
                  <span className="text-right text-base font-extrabold">
                    {formatPrice(
                      plan.Price,
                    )}
                  </span>
