...
export async function ensureSuperAdmin(): Promise<void> {
  ...
  /*
   * The bootstrap credentials are the source of truth for
   * the built-in Super Admin account.
   *
   * Always regenerate and store the hash from ADMIN_PIN.
   * This repairs an existing account whose stored PIN hash
   * is stale, invalid, or was created with a different PIN.
   */
