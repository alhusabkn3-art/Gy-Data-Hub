      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 bg-[#0A1628] border-t border-border z-50 rounded-t-3xl max-w-md mx-auto overflow-y-auto"
            ...
            <div className="p-6 pb-10">
              ...
              <div className="grid grid-cols-4 gap-y-6 gap-x-2 pb-8">
                {services.map((service) => (
                  ...
                  >
                    <div className="w-14 h-14 rounded-2xl bg-card border border-border flex items-center justify-center group-hover:bg-white/5 transition-colors">
