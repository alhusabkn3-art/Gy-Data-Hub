...
export default function RegisterScreen() {
  ...
  const handleConfirmPinKey = async (key: string) => {
    ...
    try {
      /*
       * AppContext.register() expects:
       *
       * register(name, email, phone, username, loginPin)
       *
       * The old screen was sending:
       *
       * register(name, phone, email, newPin, username)
       *
       * which put phone/email/username/PIN into the wrong fields.
       */
      ...
      /*
       * AppContext.register() returns an object:
       *
       * { success: true }
       *
       * or
       *
       * { success: false, error: 'phone_taken' }
       *
       * Do not compare the result directly with a string.
       */
      if (!result.success) {
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-sm z-10 flex items-center gap-3 mb-6">
        ...
        <div
          className={
            step === 'success' ? 'flex-1 text-center' : 'flex-1'
          }
        >
      ...
      <motion.div
        ...
        style={{
          ...
          borderRadius: 28,
          boxShadow:
            '0 24px 60px rgba(11,31,78,0.35), 0 8px 24px rgba(11,31,78,0.2)',
          ...
          <>
            <div className="text-center mb-6">
              ...
              <p
                ...
                style={{ color: '#6B7FA3' }}
              >
                Let's set up your GY DATA account
              </p>
            </div>
