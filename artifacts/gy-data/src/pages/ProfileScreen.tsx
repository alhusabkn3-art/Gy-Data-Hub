    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <div
            className={`px-4 py-1.5 border rounded-full flex items-center gap-2 ${kycBg}`}
          >
            <span
            ...
            <span
              className={`text-xs font-semibold ${kycColor}`}
            >
              {kycLabel}
            </span>
          </div>
          ...
          <>
            ...
            >
              ...
              <p className="text-muted-foreground text-sm text-center mb-6">
                You will need to enter your phone number and PIN to log back in.
              </p>
      ...
      <AnimatePresence>
        {showPinModal && (
          <PinChangeModal
            type={showPinModal}
            verifyLoginPin={verifyPin}
            changeLoginPin={changePin}
...
function PinChangeModal({
  ...
  const finishChange = async () => {
    ...
    if (
      ...
      result.error
        ?.toLowerCase()
        .includes('currentpurchasepin')
    ) {
      setStep('current');

      toast.message(
        'Enter your current Purchase PIN.',
      );
      ...
      >
          ...
          {keys.map((key, i) => (
            <button
              ...
              className={`h-12 rounded-xl flex items-center justify-center text-lg font-medium transition-all active:scale-95 ${
                key
                  ? 'bg-muted hover:bg-black/10 text-foreground'
            ...
            >
              ...
              'backspace' ? (
                <svg
                  ...
                  strokeWidth="2"
                >
                  <path d="M21 4H8l-7 8 7 8h13a2 2 0 0 2-2V6a2 2 0 0 0-2-2z" />
                  <line
                    x1="18"
                    y1="9"
                    x2="12"
        ...
        {type === 'purchase' && (
          <p className="text-center text-xs text-muted-foreground mt-2">
            Purchase PIN is separate from your Login PIN and must contain exactly 4 digits.
          </p>
        )}
