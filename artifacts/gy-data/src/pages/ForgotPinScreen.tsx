...
export default function ForgotPinScreen() {
  ...
  const handleConfirmPinKey = async (key: string) => {
    ...
    if (next.length === 6) {
      ...
      try {
        ...
        if (!ok) {
          toast.error(
            'Verification failed — your code may have expired or is invalid. Please request a new code.',
          );
  ...
  > = {
    phone: {
      title: 'Forgot PIN?',
      sub: 'Enter your registered phone number',
    },
    otp: {
    ...
    'confirm-pin': {
      ...
      sub: 'Enter your new PIN one more time',
    },
    success: {
      title: 'PIN Reset!',
      sub: 'Your PIN has been updated successfully',
    },
  };
          ...
          >
            <div className="text-center mb-7">
              ...
              <p
                ...
                style={{ color: '#6B7FA3' }}
              >
                Enter your new 6-digit PIN again to confirm
              </p>
            </div>
