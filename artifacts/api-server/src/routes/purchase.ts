  ...
  async (
    ...
    try {
      ...
      if (
        ...
        await notifyUser(
          ...
          `${
            ...
            planName ||
            'Data plan'
          } purchased successfully for ${phone}.`,
        );
      ...
      await notifyUser(
        userId,
        'Data purchase failed',
        `Your data purchase failed. ₦${sellingPrice.toLocaleString(
          'en-NG',
        )} has been refunded.`,
      );
